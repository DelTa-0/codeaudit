/**
 * Python standard-library top-level module names (union of CPython 3.10–3.13
 * `sys.stdlib_module_names`, plus a few legacy 2.x/3.x names still commonly
 * imported in older code). These are never registry-checked and never
 * flagged phantom.
 */
export const PYTHON_STDLIB = new Set([
  "__future__", "_abc", "_aix_support", "_ast", "_asyncio", "_bisect", "_blake2",
  "_bootsubprocess", "_bz2", "_codecs", "_collections", "_collections_abc",
  "_compat_pickle", "_compression", "_contextvars", "_csv", "_ctypes", "_curses",
  "_datetime", "_decimal", "_elementtree", "_functools", "_hashlib", "_heapq",
  "_imp", "_io", "_json", "_locale", "_lsprof", "_lzma", "_markupbase", "_md5",
  "_multibytecodec", "_multiprocessing", "_opcode", "_operator", "_osx_support",
  "_pickle", "_posixshmem", "_posixsubprocess", "_py_abc", "_pydecimal", "_pyio",
  "_queue", "_random", "_sha1", "_sha2", "_sha256", "_sha3", "_sha512", "_signal",
