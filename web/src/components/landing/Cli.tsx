    ...
    <section id="cli" style={{ background: "#101512", padding: "96px 48px" }}>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          ...
          >
            $ npx codematrix scan . <span style={{ color: "#5d675e", fontSize: 12 }}>{copied ? "✓ copied" : "⧉"}</span>
          </span>
        </div>
        <div
          style={{
        ...
        >
          <div><span style={{ color: "#7b857c" }}>~/vibe/codeaudit ›</span> <span style={{ color: "#f0c064" }}>npx</span> <span style={{ color: "#e8ede8" }}>codematrix scan</span></div>
